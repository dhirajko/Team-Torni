...
public class Meetings implements Serializable {
    ...
    public Meetings(Integer id, String content, boolean state, long timestamp) {
        this.id = id;
    ...
    public Meetings(String content, boolean state, long timestamp) {
        this.content = content;
        this.astate = state;
        this.atimestamp = timestamp;
    }

    public Meetings(String content, boolean state) {
        this.content = content;
        this.astate = state;
    }
