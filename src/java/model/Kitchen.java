...
public class Kitchen implements Serializable {
    ...
    public Kitchen(Integer id, String content, boolean state, long timestamp) {
        this.id = id;
    ...
    public Kitchen(String content, boolean state, long timestamp) {
        this.content = content;
        this.astate = state;
        this.atimestamp = timestamp;
    }

    public Kitchen(String content, boolean state) {
        this.content = content;
        this.astate = state;
    }
