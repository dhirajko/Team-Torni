...
public class Reception implements Serializable{
    ...
    public Reception(Integer id, String content, boolean state, long timestamp) {
        this.id = id;
    ...
    public Reception(String content, boolean state, long timestamp) {
        this.content = content;
        this.astate = state;
        this.atimestamp = timestamp;
    }

    public Reception(String content, boolean state) {
        this.content = content;
        this.astate = state;
    }
