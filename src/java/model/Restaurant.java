...
public class Restaurant implements Serializable {
    ...
    public Restaurant(Integer id, String content, boolean state, long timestamp) {
        this.id = id;
    ...
    public Restaurant(String content, boolean state, long timestamp) {
        this.content = content;
        this.astate = state;
        this.atimestamp = timestamp;
    }

    public Restaurant(String content, boolean state) {
        this.content = content;
        this.astate = state;
    }
