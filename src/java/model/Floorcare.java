...
@Entity
@XmlRootElement
public class Floorcare implements Serializable{
    ...
    public Floorcare(Integer id, String content, boolean state, long timestamp) {
        this.id = id;
    ...
    public Floorcare(String content, boolean state, long timestamp) {
        this.content = content;
        this.astate = state;
        this.atimestamp = timestamp;
    }

    public Floorcare(String content, boolean state) {
        this.content = content;
        this.astate = state;
    }
