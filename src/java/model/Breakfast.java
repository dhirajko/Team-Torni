...
public class Breakfast implements Serializable {
    ...
    public Breakfast(Integer id, String content, boolean state, long timestamp) {
        this.id = id;
    ...
    public Breakfast(String content, boolean state, long timestamp) {
        this.content = content;
        this.astate = state;
        this.atimestamp = timestamp;
    }

    public Breakfast(String content, boolean state) {
        this.content = content;
        this.astate = state;
    }
