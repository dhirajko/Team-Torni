...
public class Bar implements Serializable {
    ...
    public Bar(Integer id, String content, boolean state, long timestamp) {
        this.id = id;
    ...
    public Bar(String content, boolean state, long timestamp) {
        this.content = content;
        this.astate = state;
        this.atimestamp = timestamp;
    }

    public Bar(String content, boolean state) {
        this.content = content;
        this.astate = state;
    }
