...
public class MeetingsFacadeREST extends AbstractFacade<Meetings> {
    ...
    public void create(Meetings entity) {
        super.create(entity);
    }
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, Meetings entity) {
        super.edit(entity);
    }
    ...
    public Meetings find(@PathParam("id") Integer id) {
